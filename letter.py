...
letter = pd.read_csv('/filepath/letter.csv')
letter = preprocess.Preprocess(letter, "Letter", [])
X, y = letter.get_data()

best_parameters, experimental_accuracy, letter_fista_differences = experiment(X, y, scheme, learning_rate, convergence_constant, max_iterations, l1_penalties, l2_penalties)
print("letter 5FCV Accuracy:", experimental_accuracy, "Best Penalty Combination:", best_parameters)

best_parameters, experimental_accuracy, letter_ista_differences = experiment(X, y, "ISTA", learning_rate, convergence_constant, max_iterations, l1_penalties, l2_penalties)
#print("letter 5FCV Accuracy:", experimental_accuracy, "Best Penalty Combination:", best_parameters)

plt.semilogy(letter_fista_differences, 'g')
plt.semilogy(letter_ista_differences, 'b')
plt.title('letter', fontsize=10, fontweight='bold')
