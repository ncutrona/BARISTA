...
class RPNB:
    ...
    def __init__(self, k, dataframe, target_attribute, test_split, continous_attributes, max_iter, convergence_constant, lambda_parameters, beta_1, beta_2):
        ...
        self.best_lambda = cross_validation.CrossValidation(self.k, self.training_samples, self.training_labels, self.max_iter, self.convergence_constant, self.lambda_parameters, self.beta_1, self.beta_2).best_lambda
